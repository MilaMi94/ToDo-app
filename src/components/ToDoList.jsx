  ...
  return (
    <div>
              ...
              {currentTodo ? (
                <>
                  <button
                    ...
                    className="bg-dodgerBlue text-white py-3 px-10 rounded-md"
                  >
                    Save
                  </button>
                  <button
      ...
      <div className=" flex items-center justify-center flex-col">
              ...
              {sortToDoList.map((todo) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <button
                      className="bg-dodgerBlue text-white p-1 rounded-md ml-2"
        ...
        <button
          className="bg-dodgerBlue text-center text-white py-3 px-10 rounded-md"
          onClick={() => {
            setShowModal(true);
          }}
        >
